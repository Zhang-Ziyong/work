 ...
 *@data
 ************************************************************************/
#ifndef REAR_PATH_RECOVERY_HPP_
#define REAR_PATH_RECOVERY_HPP_
#include <math.h>
#include <string>
...
class RearPathRecovery : public BasePathRecovery {
 public:
  RearPathRecovery();
  ~RearPathRecovery() = default;

  RearPathRecovery &operator=(const RearPathRecovery &obj) = delete;
  RearPathRecovery(const RearPathRecovery &obj) = delete;
