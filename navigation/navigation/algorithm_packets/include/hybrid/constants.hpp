...
/*!
   ...
   project. \todo All constants need to be checked and documented
*/
...
/*!
   ...
   speeding up the search by a lot \todo not yet functional
*/
...
static const double width = 0.721 + 2 * bloating;
/// [m] --- The length of the vehicle
static const double length = 0.978 + 2 * bloating;
/// [m] --- The minimum turning radius of the vehicle
static const float r = 1.7 / 0.2;
...
static const float minRoadWidth = 3;
