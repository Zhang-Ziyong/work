...
double CrossProd(const Vec2d& start_point, const Vec2d& end_point_1,
  ...
  Vec2d vector1 = end_point_1 - start_point;
  Vec2d vector2 = end_point_2 - start_point;
  return CrossProd(vector1(0), vector1(1), vector2(0), vector2(1));
}

double InnerProd(const Vec2d& start_point, const Vec2d& end_point_1,
                 const Vec2d& end_point_2) {
  return ((end_point_1 - start_point).transpose() * (end_point_2 - start_point));
}
