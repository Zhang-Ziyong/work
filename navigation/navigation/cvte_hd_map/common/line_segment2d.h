 ...
 * @author linyanlong name (linyanlong@domain.com)
 * @brief 
 * @version 0.1
 * @date 2021-12-14
 * 
...
#ifndef LINE_SEGMENT_HPP_
#define LINE_SEGMENT_HPP_
#include <string>
#include <vector>
...
class LineSegment2d {
 public:
   ...
   */
  double cos_heading() const { return unit_direction_(0); }

  /**
   * @brief Get the sine of the heading.
   * @return The sine of the heading.
   */
  double sin_heading() const { return unit_direction_(1); }
