...
namespace google {
namespace protobuf {
template<> ::cvte::hdmap::Crosswalk* Arena::CreateMaybeMessage<::cvte::hdmap::Crosswalk>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace cvte {
namespace hdmap {
...
class Crosswalk : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cvte.hdmap.Crosswalk) */ {
 public:
  Crosswalk();
  virtual ~Crosswalk();
  ...
  // @@protoc_insertion_point(class_scope:cvte.hdmap.Crosswalk)
 private:
  void set_has_id();
  void clear_has_id();
...
inline const ::cvte::hdmap::Id& Crosswalk::_internal_id() const {
  return *id_;
}
inline const ::cvte::hdmap::Id& Crosswalk::id() const {
  const ::cvte::hdmap::Id* p = id_;
  // @@protoc_insertion_point(field_get:cvte.hdmap.Crosswalk.id)
  return p != NULL ? *p : *reinterpret_cast<const ::cvte::hdmap::Id*>(
      &::cvte::hdmap::_Id_default_instance_);
}
inline ::cvte::hdmap::Id* Crosswalk::release_id() {
  // @@protoc_insertion_point(field_release:cvte.hdmap.Crosswalk.id)
  clear_has_id();
  ::cvte::hdmap::Id* temp = id_;
  id_ = NULL;
  return temp;
}
inline ::cvte::hdmap::Id* Crosswalk::mutable_id() {
  set_has_id();
  if (id_ == NULL) {
    auto* p = CreateMaybeMessage<::cvte::hdmap::Id>(GetArenaNoVirtual());
    id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.Crosswalk.id)
  return id_;
}
inline void Crosswalk::set_allocated_id(::cvte::hdmap::Id* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:cvte.hdmap.Crosswalk.id)
}
...
inline const ::cvte::hdmap::Polygon& Crosswalk::_internal_polygon() const {
  return *polygon_;
}
inline const ::cvte::hdmap::Polygon& Crosswalk::polygon() const {
  const ::cvte::hdmap::Polygon* p = polygon_;
  // @@protoc_insertion_point(field_get:cvte.hdmap.Crosswalk.polygon)
  return p != NULL ? *p : *reinterpret_cast<const ::cvte::hdmap::Polygon*>(
      &::cvte::hdmap::_Polygon_default_instance_);
}
inline ::cvte::hdmap::Polygon* Crosswalk::release_polygon() {
  // @@protoc_insertion_point(field_release:cvte.hdmap.Crosswalk.polygon)
  clear_has_polygon();
  ::cvte::hdmap::Polygon* temp = polygon_;
  polygon_ = NULL;
  return temp;
}
inline ::cvte::hdmap::Polygon* Crosswalk::mutable_polygon() {
  set_has_polygon();
  if (polygon_ == NULL) {
    auto* p = CreateMaybeMessage<::cvte::hdmap::Polygon>(GetArenaNoVirtual());
    polygon_ = p;
  }
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.Crosswalk.polygon)
  return polygon_;
}
inline void Crosswalk::set_allocated_polygon(::cvte::hdmap::Polygon* polygon) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  polygon_ = polygon;
  // @@protoc_insertion_point(field_set_allocated:cvte.hdmap.Crosswalk.polygon)
}
...
inline ::cvte::hdmap::Id* Crosswalk::mutable_overlap_id(int index) {
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.Crosswalk.overlap_id)
  return overlap_id_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cvte::hdmap::Id >*
Crosswalk::mutable_overlap_id() {
  // @@protoc_insertion_point(field_mutable_list:cvte.hdmap.Crosswalk.overlap_id)
  return &overlap_id_;
}
inline const ::cvte::hdmap::Id& Crosswalk::overlap_id(int index) const {
  // @@protoc_insertion_point(field_get:cvte.hdmap.Crosswalk.overlap_id)
  return overlap_id_.Get(index);
}
inline ::cvte::hdmap::Id* Crosswalk::add_overlap_id() {
  // @@protoc_insertion_point(field_add:cvte.hdmap.Crosswalk.overlap_id)
  return overlap_id_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cvte::hdmap::Id >&
Crosswalk::overlap_id() const {
  // @@protoc_insertion_point(field_list:cvte.hdmap.Crosswalk.overlap_id)
  return overlap_id_;
}
