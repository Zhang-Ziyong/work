...
namespace google {
namespace protobuf {
template<> ::cvte::hdmap::RSU* Arena::CreateMaybeMessage<::cvte::hdmap::RSU>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace cvte {
namespace hdmap {
...
class RSU : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cvte.hdmap.RSU) */ {
 public:
  RSU();
  virtual ~RSU();
  ...
  // @@protoc_insertion_point(class_scope:cvte.hdmap.RSU)
 private:
  void set_has_id();
  void clear_has_id();
...
inline const ::cvte::hdmap::Id& RSU::_internal_id() const {
  return *id_;
}
inline const ::cvte::hdmap::Id& RSU::id() const {
  const ::cvte::hdmap::Id* p = id_;
  // @@protoc_insertion_point(field_get:cvte.hdmap.RSU.id)
  return p != NULL ? *p : *reinterpret_cast<const ::cvte::hdmap::Id*>(
      &::cvte::hdmap::_Id_default_instance_);
}
inline ::cvte::hdmap::Id* RSU::release_id() {
  // @@protoc_insertion_point(field_release:cvte.hdmap.RSU.id)
  clear_has_id();
  ::cvte::hdmap::Id* temp = id_;
  id_ = NULL;
  return temp;
}
inline ::cvte::hdmap::Id* RSU::mutable_id() {
  set_has_id();
  if (id_ == NULL) {
    auto* p = CreateMaybeMessage<::cvte::hdmap::Id>(GetArenaNoVirtual());
    id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.RSU.id)
  return id_;
}
inline void RSU::set_allocated_id(::cvte::hdmap::Id* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:cvte.hdmap.RSU.id)
}
...
inline const ::cvte::hdmap::Id& RSU::_internal_junction_id() const {
  return *junction_id_;
}
inline const ::cvte::hdmap::Id& RSU::junction_id() const {
  const ::cvte::hdmap::Id* p = junction_id_;
  // @@protoc_insertion_point(field_get:cvte.hdmap.RSU.junction_id)
  return p != NULL ? *p : *reinterpret_cast<const ::cvte::hdmap::Id*>(
      &::cvte::hdmap::_Id_default_instance_);
}
inline ::cvte::hdmap::Id* RSU::release_junction_id() {
  // @@protoc_insertion_point(field_release:cvte.hdmap.RSU.junction_id)
  clear_has_junction_id();
  ::cvte::hdmap::Id* temp = junction_id_;
  junction_id_ = NULL;
  return temp;
}
inline ::cvte::hdmap::Id* RSU::mutable_junction_id() {
  set_has_junction_id();
  if (junction_id_ == NULL) {
    auto* p = CreateMaybeMessage<::cvte::hdmap::Id>(GetArenaNoVirtual());
    junction_id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.RSU.junction_id)
  return junction_id_;
}
inline void RSU::set_allocated_junction_id(::cvte::hdmap::Id* junction_id) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cvte.hdmap.RSU.junction_id)
}
...
inline ::cvte::hdmap::Id* RSU::mutable_overlap_id(int index) {
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.RSU.overlap_id)
  return overlap_id_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cvte::hdmap::Id >*
RSU::mutable_overlap_id() {
  // @@protoc_insertion_point(field_mutable_list:cvte.hdmap.RSU.overlap_id)
  return &overlap_id_;
}
inline const ::cvte::hdmap::Id& RSU::overlap_id(int index) const {
  // @@protoc_insertion_point(field_get:cvte.hdmap.RSU.overlap_id)
  return overlap_id_.Get(index);
}
inline ::cvte::hdmap::Id* RSU::add_overlap_id() {
  // @@protoc_insertion_point(field_add:cvte.hdmap.RSU.overlap_id)
  return overlap_id_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cvte::hdmap::Id >&
RSU::overlap_id() const {
  // @@protoc_insertion_point(field_list:cvte.hdmap.RSU.overlap_id)
  return overlap_id_;
}
