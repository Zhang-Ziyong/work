...
namespace google {
namespace protobuf {
template<> ::cvte::hdmap::Id* Arena::CreateMaybeMessage<::cvte::hdmap::Id>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace cvte {
namespace hdmap {
...
class Id : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cvte.hdmap.Id) */ {
 public:
  Id();
  virtual ~Id();
  ...
  // @@protoc_insertion_point(class_scope:cvte.hdmap.Id)
 private:
  void set_has_id();
  void clear_has_id();
...
inline const ::std::string& Id::id() const {
  // @@protoc_insertion_point(field_get:cvte.hdmap.Id.id)
  return id_.GetNoArena();
}
inline void Id::set_id(const ::std::string& value) {
  set_has_id();
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:cvte.hdmap.Id.id)
}
#if LANG_CXX11
inline void Id::set_id(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:cvte.hdmap.Id.id)
}
#endif
inline void Id::set_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:cvte.hdmap.Id.id)
}
inline void Id::set_id(const char* value, size_t size) {
  set_has_id();
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:cvte.hdmap.Id.id)
}
inline ::std::string* Id::mutable_id() {
  set_has_id();
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.Id.id)
  return id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Id::release_id() {
  // @@protoc_insertion_point(field_release:cvte.hdmap.Id.id)
  if (!has_id()) {
    return NULL;
  }
  clear_has_id();
...
inline void Id::set_allocated_id(::std::string* id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cvte.hdmap.Id.id)
}
