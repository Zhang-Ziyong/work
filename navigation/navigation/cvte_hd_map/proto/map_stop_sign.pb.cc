...
static void InitDefaultsStopSign() {
  ...
  {
    void* ptr = &::cvte::hdmap::_StopSign_default_instance_;
    new (ptr) ::cvte::hdmap::StopSign();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::cvte::hdmap::StopSign::InitAsDefaultInstance();
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cvte::hdmap::StopSign, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cvte::hdmap::StopSign, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cvte::hdmap::StopSign, id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cvte::hdmap::StopSign, stop_line_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cvte::hdmap::StopSign, overlap_id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cvte::hdmap::StopSign, type_),
  0,
  ~0u,
  ~0u,
  1,
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, sizeof(::cvte::hdmap::StopSign)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::cvte::hdmap::_StopSign_default_instance_),
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\023map_stop_sign.proto\022\ncvte.hdmap\032\014map_i"
      "d.proto\032\022map_geometry.proto\"\372\001\n\010StopSign"
      "\022\032\n\002id\030\001 \001(\0132\016.cvte.hdmap.Id\022$\n\tstop_lin"
      "e\030\002 \003(\0132\021.cvte.hdmap.Curve\022\"\n\noverlap_id"
      "\030\003 \003(\0132\016.cvte.hdmap.Id\022+\n\004type\030\004 \001(\0162\035.c"
      "vte.hdmap.StopSign.StopType\"[\n\010StopType\022"
      "\013\n\007UNKNOWN\020\000\022\013\n\007ONE_WAY\020\001\022\013\n\007TWO_WAY\020\002\022\r"
...
void StopSign::InitAsDefaultInstance() {
  ::cvte::hdmap::_StopSign_default_instance_._instance.get_mutable()->id_ = const_cast< ::cvte::hdmap::Id*>(
...
StopSign::StopSign()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:cvte.hdmap.StopSign)
}
StopSign::StopSign(const StopSign& from)
  ...
  type_ = from.type_;
  // @@protoc_insertion_point(copy_constructor:cvte.hdmap.StopSign)
}
...
StopSign::~StopSign() {
  // @@protoc_insertion_point(destructor:cvte.hdmap.StopSign)
  SharedDtor();
}
...
void StopSign::Clear() {
// @@protoc_insertion_point(message_clear_start:cvte.hdmap.StopSign)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:cvte.hdmap.StopSign)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // optional .cvte.hdmap.StopSign.StopType type = 4;
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::cvte::hdmap::StopSign_StopType_IsValid(value)) {
            set_type(static_cast< ::cvte::hdmap::StopSign_StopType >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:cvte.hdmap.StopSign)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:cvte.hdmap.StopSign)
  return false;
#undef DO_
}
...
void StopSign::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:cvte.hdmap.StopSign)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:cvte.hdmap.StopSign)
}

::google::protobuf::uint8* StopSign::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:cvte.hdmap.StopSign)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cvte.hdmap.StopSign)
  return target;
}

size_t StopSign::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:cvte.hdmap.StopSign)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:cvte.hdmap.StopSign)
  GOOGLE_DCHECK_NE(&from, this);
  const StopSign* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const StopSign>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:cvte.hdmap.StopSign)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:cvte.hdmap.StopSign)
    MergeFrom(*source);
  }
}

void StopSign::MergeFrom(const StopSign& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:cvte.hdmap.StopSign)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:cvte.hdmap.StopSign)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:cvte.hdmap.StopSign)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cvte::hdmap::StopSign* Arena::CreateMaybeMessage< ::cvte::hdmap::StopSign >(Arena* arena) {
  return Arena::CreateInternal< ::cvte::hdmap::StopSign >(arena);
}
}  // namespace protobuf
}  // namespace google
