...
namespace google {
namespace protobuf {
template<> ::cvte::hdmap::ClearArea* Arena::CreateMaybeMessage<::cvte::hdmap::ClearArea>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace cvte {
namespace hdmap {
...
class ClearArea : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cvte.hdmap.ClearArea) */ {
 public:
  ClearArea();
  virtual ~ClearArea();
  ...
  // @@protoc_insertion_point(class_scope:cvte.hdmap.ClearArea)
 private:
  void set_has_id();
  void clear_has_id();
...
inline const ::cvte::hdmap::Id& ClearArea::_internal_id() const {
  return *id_;
}
inline const ::cvte::hdmap::Id& ClearArea::id() const {
  const ::cvte::hdmap::Id* p = id_;
  // @@protoc_insertion_point(field_get:cvte.hdmap.ClearArea.id)
  return p != NULL ? *p : *reinterpret_cast<const ::cvte::hdmap::Id*>(
      &::cvte::hdmap::_Id_default_instance_);
}
inline ::cvte::hdmap::Id* ClearArea::release_id() {
  // @@protoc_insertion_point(field_release:cvte.hdmap.ClearArea.id)
  clear_has_id();
  ::cvte::hdmap::Id* temp = id_;
  id_ = NULL;
  return temp;
}
inline ::cvte::hdmap::Id* ClearArea::mutable_id() {
  set_has_id();
  if (id_ == NULL) {
    auto* p = CreateMaybeMessage<::cvte::hdmap::Id>(GetArenaNoVirtual());
    id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.ClearArea.id)
  return id_;
}
inline void ClearArea::set_allocated_id(::cvte::hdmap::Id* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:cvte.hdmap.ClearArea.id)
}
...
inline ::cvte::hdmap::Id* ClearArea::mutable_overlap_id(int index) {
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.ClearArea.overlap_id)
  return overlap_id_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cvte::hdmap::Id >*
ClearArea::mutable_overlap_id() {
  // @@protoc_insertion_point(field_mutable_list:cvte.hdmap.ClearArea.overlap_id)
  return &overlap_id_;
}
inline const ::cvte::hdmap::Id& ClearArea::overlap_id(int index) const {
  // @@protoc_insertion_point(field_get:cvte.hdmap.ClearArea.overlap_id)
  return overlap_id_.Get(index);
}
inline ::cvte::hdmap::Id* ClearArea::add_overlap_id() {
  // @@protoc_insertion_point(field_add:cvte.hdmap.ClearArea.overlap_id)
  return overlap_id_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cvte::hdmap::Id >&
ClearArea::overlap_id() const {
  // @@protoc_insertion_point(field_list:cvte.hdmap.ClearArea.overlap_id)
  return overlap_id_;
}
...
inline const ::cvte::hdmap::Polygon& ClearArea::_internal_polygon() const {
  return *polygon_;
}
inline const ::cvte::hdmap::Polygon& ClearArea::polygon() const {
  const ::cvte::hdmap::Polygon* p = polygon_;
  // @@protoc_insertion_point(field_get:cvte.hdmap.ClearArea.polygon)
  return p != NULL ? *p : *reinterpret_cast<const ::cvte::hdmap::Polygon*>(
      &::cvte::hdmap::_Polygon_default_instance_);
}
inline ::cvte::hdmap::Polygon* ClearArea::release_polygon() {
  // @@protoc_insertion_point(field_release:cvte.hdmap.ClearArea.polygon)
  clear_has_polygon();
  ::cvte::hdmap::Polygon* temp = polygon_;
  polygon_ = NULL;
  return temp;
}
inline ::cvte::hdmap::Polygon* ClearArea::mutable_polygon() {
  set_has_polygon();
  if (polygon_ == NULL) {
    auto* p = CreateMaybeMessage<::cvte::hdmap::Polygon>(GetArenaNoVirtual());
    polygon_ = p;
  }
  // @@protoc_insertion_point(field_mutable:cvte.hdmap.ClearArea.polygon)
  return polygon_;
}
inline void ClearArea::set_allocated_polygon(::cvte::hdmap::Polygon* polygon) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  polygon_ = polygon;
  // @@protoc_insertion_point(field_set_allocated:cvte.hdmap.ClearArea.polygon)
}
